...
project = u'ftrack-connect-pipeline-definition'
copyright = u'2022, ftrack'
author = u'ftrack'

# contents of docs/conf.py
try:
    release = get_distribution('ftrack-connect-pipeline-definition').version
...
modindex_common_prefix = ['ftrack-connect-pipeline-definition.']
...
htmlhelp_basename = 'ftrack-connect-pipeline-definitiondoc'
...
latex_documents = [
    (
        master_doc,
        'ftrack-connect-pipeline-definition.tex',
        u'ftrack-connect-pipeline-definition Documentation',
        u'ftrack',
        'manual',
    ),
]
