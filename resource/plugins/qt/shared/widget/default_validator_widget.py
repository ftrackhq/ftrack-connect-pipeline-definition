...
class DefaultValidatorWidget(dynamic_widget.DynamicWidget):
    ...
    def __init__(
            self, parent=None, context_id=None, asset_type=None, session=None, data=None, name=None,
        ...
        *name*, *description*, *options*
        ...
        super(DefaultValidatorWidget, self).__init__(
            parent=parent, context_id=context_id, asset_type=asset_type, session=session, data=data, name=name,
