...
class HoudiniGeometryPublisherCollectorOptionsWidget(BaseCollectorWidget):
    ...
    def __init__(
        ...
        super(HoudiniGeometryPublisherCollectorOptionsWidget, self).__init__(
            parent=parent,
            session=session,
            data=data,
            name=name,
...
class HoudiniGeometryPublisherCollectorPluginWidget(
    plugin.HoudiniPublisherCollectorPluginWidget
):
    plugin_name = 'houdini_geometry_publisher_collector'
    widget = HoudiniGeometryPublisherCollectorOptionsWidget
...
def register(api_object, **kw):
    if not isinstance(api_object, ftrack_api.Session):
        ...
        return
    plugin = HoudiniGeometryPublisherCollectorPluginWidget(api_object)
    plugin.register()
