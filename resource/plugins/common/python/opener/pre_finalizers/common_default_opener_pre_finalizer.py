...
class CommonDefaultOpenerPreFinalizerPlugin(plugin.OpenerPreFinalizerPlugin):
    plugin_name = 'common_default_opener_pre_finalizer'
...
def register(api_object, **kw):
    if not isinstance(api_object, ftrack_api.Session):
        ...
        return
    plugin = CommonDefaultOpenerPreFinalizerPlugin(api_object)
    plugin.register()
