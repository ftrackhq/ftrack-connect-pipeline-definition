...
class OpenTestWidget(OpenBaseWidget):
    load_modes = ['Open']
    ...
    def __init__(
        ...
        super(OpenTestWidget, self).__init__(
            parent=parent,
            session=session,
            data=data,
            name=name,
    ...
    def build(self):
        super(OpenTestWidget, self).build()
    ...
    def post_build(self):
        super(OpenTestWidget, self).post_build()
    ...
    def set_defaults(self):
        super(OpenTestWidget, self).set_defaults()
    ...
    def _on_load_mode_changed(self, radio_button):
        ...
        super(OpenTestWidget, self)._on_load_mode_changed(radio_button)
...
class OpenTestPluginPluginWidget(pluginWidget.OpenerImporterPluginWidget):
    plugin_name = 'importer_test'
    widget = OpenTestWidget
...
def register(api_object, **kw):
    if not isinstance(api_object, ftrack_api.Session):
        ...
        return
    plugin = OpenTestPluginPluginWidget(api_object)
    plugin.register()
