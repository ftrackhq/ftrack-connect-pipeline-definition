...
class UnrealNativeLoaderImporterOptionsWidget(LoadBaseWidget):
    ...
    def __init__(
        ...
        super(UnrealNativeLoaderImporterOptionsWidget, self).__init__(
            parent=parent,
            session=session,
            data=data,
            name=name,
    ...
    def build(self):
        super(UnrealNativeLoaderImporterOptionsWidget, self).build()
    ...
    def post_build(self):
        super(UnrealNativeLoaderImporterOptionsWidget, self).post_build()
    ...
    def set_defaults(self):
        super(UnrealNativeLoaderImporterOptionsWidget, self).set_defaults()
    ...
    def _on_load_mode_changed(self, radio_button):
        ...
        super(
            UnrealNativeLoaderImporterOptionsWidget, self
...
class UnrealNativeLoaderImporterPluginWidget(
    plugin.UnrealLoaderImporterPluginWidget
):
    plugin_name = 'unreal_native_loader_importer'
    widget = UnrealNativeLoaderImporterOptionsWidget
...
def register(api_object, **kw):
    if not isinstance(api_object, ftrack_api.Session):
        ...
        return
    plugin = UnrealNativeLoaderImporterPluginWidget(api_object)
    plugin.register()
