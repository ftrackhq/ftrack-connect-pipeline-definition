...
class UnrealRegexPublisherCollectorPlugin(plugin.UnrealPublisherCollectorPlugin):
    plugin_name = 'unreal_regex_publisher_collector'
...
def register(api_object, **kw):
    if not isinstance(api_object, ftrack_api.Session):
        ...
        return
    plugin = UnrealRegexPublisherCollectorPlugin(api_object)
    plugin.register()
