...
class UnrealGenericPublisherCollectorOptionsWidget(BaseCollectorWidget):
    ...
    def __init__(
        ...
        super(UnrealGenericPublisherCollectorOptionsWidget, self).__init__(
            parent=parent,
            session=session,
            data=data,
            name=name,
...
class UnrealGenericPublisherCollectorPluginWidget(
    plugin.UnrealPublisherCollectorPluginWidget
):
    plugin_name = 'unreal_generic_publisher_collector'
    widget = UnrealGenericPublisherCollectorOptionsWidget
...
def register(api_object, **kw):
    if not isinstance(api_object, ftrack_api.Session):
        ...
        return
    plugin = UnrealGenericPublisherCollectorPluginWidget(api_object)
    plugin.register()
