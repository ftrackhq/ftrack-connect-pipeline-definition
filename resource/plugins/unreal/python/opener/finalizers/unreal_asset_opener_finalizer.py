...
class UnrealAssetOpenerFinalizerPlugin(plugin.UnrealOpenerFinalizerPlugin):
    '''Unreal asset open finalizer plugin.'''

    plugin_name = 'unreal_asset_opener_finalizer'
...
def register(api_object, **kw):
    if not isinstance(api_object, ftrack_api.Session):
        ...
        return
    plugin = UnrealAssetOpenerFinalizerPlugin(api_object)
    plugin.register()
