...
class NukeDefaultOpenerImporterPlugin(plugin.NukeOpenerImporterPlugin):
    plugin_name = 'nuke_default_opener_importer'
...
def register(api_object, **kw):
    if not isinstance(api_object, ftrack_api.Session):
        ...
        return
    plugin = NukeDefaultOpenerImporterPlugin(api_object)
    plugin.register()
